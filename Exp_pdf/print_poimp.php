...
.style1 {
	font-size: 12px;
	font-family: "Bookman Old Style", Gadget, sans-serif;;}
.style2 {font-size: 12px}
</style>

<table width="790" height="190" border="0" style="font-size:12px;">
  <tr>
    <td height="20" colspan="3" align="center"><strong> PT SEMARANG AUTOCOMP MANUFACTURING INDONESIA</strong></td>
    <td colspan="3" align="center"><strong><?php echo odbc_result($tb_qry_supp,"SUPP_NAME"); ?></strong></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td colspan="3" align="center"><strong><em>WIRING HARNESS MANUFACTURER</em></strong></td>
    <td colspan="3" rowspan="2"><?php echo ucwords(strtolower(odbc_result($tb_qry_supp,"alamat")))." ".odbc_result($tb_qry_supp,"kota")." ".odbc_result($tb_qry_supp,"kode_pos"); ?></td>
    <td style="font-size:16px;">&nbsp;</td>
  </tr>
  <tr>
    <td width="111" scope="row">Office / Factory</td>
    <td width="6" scope="row">:</td>
    <td width="307"> Jl. Walisongo Km 9,8 Kelurahan Tugu Rejo,</td>
    <td style="font-size:10px;" align="left">&nbsp;</td>
  </tr>
  <tr>
    <td></td>
    <td></td>
    <td> Kecamatan Tugu, Semarang 50151</td>
    <td width="58">Attn</td>
    <td width="3">:</td>
    <td width="194"><?php echo odbc_result($tb_qry_supp,"cp_name");?></td>
    <td style="font-size:10px;" align="left">&nbsp;</td>
  </tr>
  <tr>
    <td></td>
  ...
  <tr>
    ...
    <td>Email</td>
    <td>:</td>
    <td rowspan="2" align="left" valign="top"><?php echo strtolower(odbc_result($tb_qry_supp,"email"));?></td>
    <td style="font-size:10px;" align="left">&nbsp;</td>
  </tr>
  <tr>
    <td></td>
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td width="81" rowspan="3"><img src="../images/confidential.jpg" height="60" width="80"></td>
  </tr>
  <tr>
    <td>Phone
    <td>:
    <td> 62-24-866 5182</td>
    <td>Phone</td>
    <td>:</td>
    <td><?php
...
<p>PURCHASE ORDER</p>
<table width="790" border="1" style="border-collapse: collapse; font-size:10px;">

  <tr>
    <td height="30" colspan="2" align="left" valign="bottom">Attachement  : ...sheets</td>
    </tr>
  <tr>
    <td width="550" height="174">
	<table width="550" style="border-collapse: collapse; font-size:10px; vertical-align:top;" border="1">
      <tr>
        <th width="33" rowspan="2">No</th>
        <th colspan="2">Desc. of Goods </th>
        <th width="43">Qty</th>
        <th width="91">Price</th>
        <th width="64">Amount</th>
        <th width="43" rowspan="2">Remark</th>
      </tr>
      <tr>
        <th width="116">Part Name</th>
        <th width="114">Part No </th>
        <th>PC</th>
        <th>USD</th>
        <th>USD</th>
      </tr>
    ...
    <td width="240">
	<table width="221" border="0" style="border-collapse: collapse; font-size:10px;">
      <tr>
        <td width="99" scope="row">DATE</td>
        <td width="3">:</td>
        <td width="105">&nbsp;</td>
      </tr>
      <tr>
        <td scope="row">REQ. NO</td>
        <td>:</td>
        <td rowspan="2">&nbsp;</td>
      </tr>
      <tr>
      ...
      <tr>
        <td scope="row">TERMS</td>
        <td>:</td>
        <td>&nbsp;</td>
      </tr>
      <tr>
        <td scope="row">ETA SAMI</td>
        <td>:</td>
        <td>&nbsp;</td>
      </tr>
      <tr>
      ...
      <tr>
        <td colspan="3" scope="row" align="center">AIR SHIPMENT PERMISSION</td>
      </tr>
      <tr>
        <td scope="row">REASON REQUEST</td>
        <td>:</td>
        <td>&nbsp;</td>
      </tr>
      <tr>
        <td rowspan="2" scope="row">ESTIMATE WEIGHT/ COST</td>
        <td>:</td>
        <td>&nbsp;</td>
      </tr>
      <tr>
...
<p valign="bottom">Attachement  : ...sheets</p>
...
while(odbc_fetch_array($tb_dtlpo)){
	...
	$Amo=$prc*$qt;
	$amn_pph=floor($pph*$Amo/100);
	$t_Amo=$t_Amo+$Amo;
	if($lp!='LD'){$ppn=floor($t_Amo/odbc_result($tb_dtlpo,"ppn"));}else{$ppn=0;}
	$GT=$ppn+$t_Amo-$amn_pph;
	$xy++
?>
	<tr class="odd gradeX">
	<td height="23" align="center" valign="middle" nowrap="nowrap"><?php echo $xy;?></td>
	<td align="center" valign="middle" nowrap="nowrap"><?php echo odbc_result($tb_dtlpo,"part_no");?></td>
	...
	<td align="center" valign="middle"></td>
	<td align="center" valign="middle"></td>
	<td align="center" valign="middle"><?php echo $curr." ".number_format(sprintf("%.2f",$ppn),2,'.',',');?></td>
    </tr>
	<?php
	if($pph>0){
	?>
	...
	<td align="center" valign="middle"></td>
	<td align="center" valign="middle"></td>
	<td align="center" valign="middle">( <?php echo $curr." ".number_format(sprintf("%.2f",$amn_pph),2,'.',',');?> )</td>
    </tr>
	<?php }?>
	<tr>
	...
	<td align="center" valign="middle"></td>
	<td align="center" valign="middle"></td>
	<td align="center" valign="middle"><?php echo $curr." ".number_format(sprintf("%.2f",$GT),2,'.',',');?></td>
    </tr>
</tbody>
</table>
...
<tr>
<td height="20" width="334" align="center">For Stock Crimper Dies SAMI TUGU</td>
<td width="440" align="center">Invoice Address</td>
</tr>

<tr>
<td width="334" valign="top" >
Please sign below and send back  this page to us by fax or email&nbsp;  transmision on following day after acepptance of this order(max 2 days). If&nbsp;  we didn't received under 2 days, we decide&nbsp; our Purchase Order have been acceptanced. Please deliver the component(s)  with latest level, on time, pack with safe way and free from Cadmium (Cd),  Chromium Hexavalent (Cr6+),&nbsp;&nbsp;  Lead (Pb), Mercury (Hg) -&gt; (Free SOC/ ELV, and any Hazardous Substance &amp; follow goverment  regulation).</td>
<td width="440">
<table width="440" border="0" style="border-collapse: collapse; font-family: Arial, Helvetica, sans-serif; text-align: left; font-size:12px;">
  <tr>
    <td width="109">TAX ID No.</td>
    <td width="6">:</td>
    <td width="311">01.869.469.5-055.000</td>
  </tr>
  <tr>
    <td scope="row">Invoice Address</td>
    <td>:</td>
    <td valign="top">Jl. Walisongo Km 9,8 Kelurahan Tugu Rejo </td>
  </tr>
  <tr>
    <td height="17" valign="top">&nbsp;</td>
    <td height="40" rowspan="2" valign="top">&nbsp;</td>
    <td valign="top">Kecamatan Tugu, Semarang 50151 </td>
  </tr>
  <tr>
    <td height="19" valign="top">&nbsp;</td>
    <td height="19" valign="top">Jawa Tengah - Indonesia</td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan="3" scope="row">Manufacture Tooling Procurement</td>
  </tr>
  <tr>
    <td scope="row">e-mail</td>
    <td>:</td>
    <td>pe_02@sami.co.id</td>
  </tr>
    <tr>
