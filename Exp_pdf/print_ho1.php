...
$sql_stk1="select sect,pr_no,po_no,pic_lp,part_no,part_nm,part_dtl,part_desc,pic_terima,tgl_terima,sum(qty) AS qty,uom from bps_serahterima where ho_no='$kd'
group by sect,pr_no,po_no,pic_lp,part_no,part_nm,part_dtl,part_desc,pic_terima,tgl_terima,uom";
...
while(odbc_fetch_array($tb_stk1))
{
	...
	$pr_no=odbc_result($tb_stk1,"pr_no");
...
<table width="781" border="0">
  ...
  <tr>
    <td>DEPT/SECTION</td>
    <td>:</td>
    <td width="500"><?php echo $sect;?></td>
  </tr>
  <tr>
    <td width="113">DATE</td>
    <td width="10">:</td>
    <td width="117"><?php echo date("d F Y",strtotime($tgl));?></td>
  </tr>
  <tr>
    <td>PR NO.</td>
    <td>:</td>
