	...
	<tr>
		<td height="90" valign="top">
			...
			<p>
				...
				$tb_stk1p = odbc_exec($koneksi_lp, "SELECT * from bps_approve where no_doc='$kd' order by no_aprv asc");
				$stkip=1;
				while ($barisp = odbc_fetch_array($tb_stk1p)) {
					$qrnya = odbc_result($tb_stk1p, "qr");
					
					//Isi dari QRCode Saat discan
					$isi_teks1 = $qrnya;
					//Nama file yang akan disimpan pada folder temp 
					$namafile2 = $kd . "_".$stkip.".png";
					//Kualitas dari QRCode 
					$quality1 = 'H';
					//Ukuran besar QRCode
					$ukuran1 = 8;
					$padding1 = 0;
					QRCode::png($isi_teks1, $tempdir . $namafile2, $quality1, $ukuran1, $padding1);
...
<table border="1" style="font-family: Arial Narrow, Helvetica, sans-serif; border-collapse: collapse; font-size:14p;">
	...
	while (odbc_fetch_array($tb_aprv)) {
		...
		*/
		...
		$bar2 = $bar2 . '<td height="90" align="center" valign="center" colspan="2" style="font-family: Arial Narrow; font-size:11;"><img src="temp_qr/'. $kd.'_'.$stkipo.'.png" width="80px"></td>';
