			...
			<tr class="odd gradeX">
				...
				<tr align="center" valign="middle">
					...
					// DATEADD(n,1,'$updtpr')
						...
						$qry_add=odbc_exec($koneksi_lp,"select isnull(SUM(dbo.lp_konprc(term, 'USD',curr,price*Qty)),0) as amn from bps_budget_add 
							where sect='$sec' and periode='$per' and doc_no is not null");
						...
						<tr>
							...
							<td colspan="3" rowspan="3">
								<ul>
									...
									sect=a.sect and periode=a.periode and tgl_updt<=DATEADD(n,1,'$updtpr'))";
