	...
	<tr>
		<td width="314">
			<table style="font-size:12px;">
				...
				<tr>
					<td>REGISTERED NO.　登録番号</td>
					<td>:</td>
					<td><?php echo $prno;?></td>
				</tr>
				<tr>
					<td width="113">DEPT/SECTION　部署･セクション</td>
					<td>:</td>
					<td><?php echo $sec_bud[0]." / ".$sec_bud[1];?></td>
				</tr>
				<tr>
					<td width="113">PERIODE BUDGET　検収月</td>
					<td>:</td>
					<td><?php echo $per_bud;?></td>
				</tr>
				<tr>
					<td width="113">KATEGORI　分類</td>
					<td>:</td>
					<td><?php echo $phs;?></td>
				</tr>
			</table>
...
<table border="1" style="border-collapse: collapse; font-size:10px; width:800px; font-weight: bold;">
	<thead>
		<tr>
			<th rowspan="2" width="29">NO.</th>
			<th width="71">BUDGET REFERENCE (PART NAME)<p></p></th>
		...
		<tr>
			<th width="71">品名</th>
			<th width="260">品物・加工の詳細</th>
			<th width="36">数量</th>
			<th width="36">通貨単位</th>
			<th width="93">単価</th>
			<th width="109">金額</th>
			<th width="73">依頼納期</th>
			<th width="77">コストセンター</th>
		</tr>
	</thead>
	<tbody>
		<?php
