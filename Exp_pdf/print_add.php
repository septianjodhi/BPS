...
// $mpdf->setHeader("Halaman {PAGENO} dari {nb}");
...
<?php
$sql_aprv="select * from bps_approve where exists(select * from bps_setApprove where status_akun='aktif' and initial=bps_approve.initial) and jns_doc='ADD' and no_doc='$kd' order by no_aprv desc,initial desc";
...
<?php
   ...
   <td width="20" align="left" valign="middle" nowrap="nowrap"><?php echo odbc_result($tb_stk31,"part_nm");?></td>
   <td width="50" align="left" valign="middle" nowrap="wrap"><?php echo odbc_result($tb_stk31,"part_no")." ".odbc_result($tb_stk31,"part_dtl")." ".odbc_result($tb_stk31,"part_desc");?></td>
   ...
   <td width="80" align="right" nowrap="nowrap"><?php echo number_format(sprintf("%.2f",$Amo),0,'.',',');?></td>
   ...
   <td width="60" align="left" nowrap="nowrap"><?php 
    ...
    <tr align="center" valign="middle">
      ...
      <td align="right	" valign="middle" nowrap="nowrap"><?php echo number_format(sprintf("%.2f",$t_Amo),0,'.',',');?></td>
