...
$qry_crphase="select distinct phase from bps_tmpPR where PR_NO='$kd'";
	...
	<tr>
		...
		<td width="456" align="right">
			<table width="388" border="1" style="border-collapse: collapse;">
				<?php
				$sql_aprv="select distinct * from bps_approve where jns_doc='PR' and no_doc='$kd' order by no_aprv desc";
		...
		while(odbc_fetch_array($tb_stk31))
		{
			...
			if($curr=='IDR'){
				...
				<tr class="odd gradeX">
					...
					<td align="left" valign="middle" nowrap="nowrap"><?php echo odbc_result($tb_stk31,"no_ctrl");?></td>
					...
					if($curr=='IDR'){
						echo number_format($Amo-1,2,".",",");}
						else {
							echo number_format(sprintf("%.2f",$Amo-1),2,'.',',');}?>
						</td>
					...
					<tr align="center" valign="middle">
						...
						<td align="center" valign="middle" nowrap="nowrap"><?php  if($curr=='IDR'){
							echo number_format(round($t_Amo-1),2,".",",");}
							else {
								echo number_format(sprintf("%.2f",$t_Amo-1),2,'.',',');}?></td>
								<td>&nbsp;</td>
								<td>&nbsp;</td>
							</tr>
							<tr align="center" valign="middle">
							...
							<tr>
								...
								//echo $crbal;
										...
										// $bal_stp=$amnpln-$amnact;
											...
											<li>E. Ending Balance (USD A-B-C-D) :
												<?php
