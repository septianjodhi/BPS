...
//$dtl_po="select bps_podtl.*,(select ppn from lp_supp where supp_code=bps_podtl.kode_supp) as ppn from bps_podtl where po_no='$pono'";
	...
	<tr>
		...
		<td align="center" valign="middle"></td>
		<td align="center" valign="middle"></td>
		<td align="center" valign="middle"><?php echo $curr." ".number_format(sprintf("%.2f",round($amn_dpp)),0,'.',',');?></td>
	</tr>
	<tr>
	...
	if($pph>0){
		...
		<tr>
			...
			<td align="center" valign="middle">
				( <?php echo $curr." ".number_format(sprintf("%.2f",round($amn_pph)),2,'.',',');?>)
			</td>
		</tr>
	<?php }?>
	<tr>
