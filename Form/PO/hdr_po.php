...
if($kode_supp==""){
echo "<h3>Belum ada kontrak supplier</h3>";
}else
{
...
<table width="790" border="0">
	<tr>
		...
		<td align="center" width="650" valign="top" style="font-family: Arial, Helvetica, sans-serif; font-size: 18px;">
			PT. SEMARANG AUTOCOMP MANUFACTURING INDONESIA '.$jeparafac.'
		</td>
		<td rowspan="2">
...
<table width="790" border="0">
	<tr>
		...
		<td>:</td>
		<td width="280"><h3>'.$pono.'</h3></td>
	</tr>
	<tr>
		<td>&nbsp;</td>
		<td>Tanggal Order </td>
		<td>:</td>
		<td>'.date("d F Y",strtotime(odbc_result($tb_qry_supp,"tgl_po"))).'</td>
	</tr>
	<tr>
		<td valign="top" align="left" colspan="3"><h3><strong>'.odbc_result($tb_qry_supp,"SUPP_NAME").'</strong></h3></td>
		<td>&nbsp;</td>
		<td>ETA Request </td>
		<td>:</td>
		<td>'.date("d F Y",strtotime(odbc_result($tb_qry_supp,"eta"))).'</td>
	</tr>

	<tr>
		<td colspan="3">'.ucwords(strtolower(odbc_result($tb_qry_supp,"alamat")))." ".odbc_result($tb_qry_supp,"kota")." ".odbc_result($tb_qry_supp,"kode_pos").'</td>
		<td>&nbsp;</td>
		<td>Document No.</td>
		<td>:</td>
		<td  style="font-size: 12px;">'.$pch_gab[1].'</td>
	</tr>
	<tr>
		<td width="50">Telp</td>
		<td>:</td>
		...
		<td>&nbsp;</td>
		<td>&nbsp;</td>
		<td  style="font-size: 12px;">'.$pch_gab[2].'</td>
	</tr>
	<tr>
		<td>Fax</td>
		<td>:</td>
		<td>'.odbc_result($tb_qry_supp,"fax").'</td>
		<td>&nbsp;</td>
		<td>&nbsp;</td>
		<td>&nbsp;</td>
		<td  style="font-size: 12px;">'. $pch_gab[3].'</td>
	</tr>
	<tr>
		<td>Attn</td>
		<td>:</td>
		<td>'.odbc_result($tb_qry_supp,"cp_name").'</td>
		<td>&nbsp;</td>
		<td colspan="3"><em>Term Of Payment '.odbc_result($tb_qry_supp,"term_of_payment").'</em></td>
	</tr>
	<tr>
		<td valign="top">Email</td>
		<td valign="top">:</td>
		<td valign="top">'.strtolower(odbc_result($tb_qry_supp,"email")).'</td>
		<td>&nbsp;</td>
...
<table width="790" border="0">
	<tr>
		<td width="10" class="sami">SAMI</td>
		<td align="center" width="650" valign="top" style="font-family: Arial, Helvetica, sans-serif; font-size: 18px;">
			PT. SEMARANG AUTOCOMP MANUFACTURING INDONESIA <?php if ($lokasi=='JF') {
				echo " - JEPARA FACTORY";
			} ?>
		</td>
		<td rowspan="2">
	...
	<tr>
		<td colspan="3" align="center" valign="top" style="font-family: Arial, Helvetica, sans-serif; text-align: center;">
			Office / Factory: <?php if ($lokasi=='TF') { ?>
				Jl. Walisongo Km 9,8 Kelurahan Tugu Rejo, Kecamatan Tugu
			<?php } else { ?>
				Jl. Jepara Kudus KM 28 Sengon Bugel, Kecamatan Mayong
			<?php } ?>
		</td>
	</tr>
	<tr>
		<td colspan="3" align="center" valign="top" style="font-family: Arial, Helvetica, sans-serif; text-align: center;">
			<?php if ($lokasi=='TF') { ?>
				Semarang 50151 Jawa Tengah - Indonesia
			<?php } else { ?>
				Jepara 59465 Jawa Tengah - Indonesia
			<?php } ?>
		</td>
	</tr>
	<tr>
		<td colspan="3" align="center" valign="top" style="font-family: Arial, Helvetica, sans-serif; text-align: center;">
			Phone : <?php if ($lokasi=='TF') { ?> 62-24-866 5182	,Fax : 62-24-866 5178
		<?php } else { ?> 6291-751-2101/ 0828-9109-2000	,Fax : 6291-751-2102 <?php } ?>
	</td>
</tr>
</table>
<hr width="790" align="center">
...
<table width="790" border="0">
	...
	<tr>
		...
		<td width="340">
			...
			$cp=odbc_result($tb_qry_supp,"CP_HP");
			$tlpn=odbc_result($tb_qry_supp,"TELP");
			if($cp!='' and $tlpn!=''){echo $tlpn." / ".$cp;}else{echo $tlpn.$cp;}?>
		</td>
		<td>&nbsp;</td>
		<td>&nbsp;</td>
		<td>&nbsp;</td>
	...
	<tr>
		...
		<td>&nbsp;</td>
		<td colspan="3"><em>Term Of Payment <?php echo odbc_result($tb_qry_supp,"term_of_payment"); ?></em></td>
	</tr>
	<tr>
		<td valign="top">Email</td>
		<td valign="top">:</td>
		<td valign="top"><?php echo strtolower(odbc_result($tb_qry_supp,"email"));?></td>
		<td>&nbsp;</td>
		<td colspan="3"><em>This P/O number and our requisition number must appear on all correspondence, invoice shipping papers.</em></td>
	</tr>
</table>
