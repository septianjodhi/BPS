...
<section class="content">
	<div class="container-fluid">
		<div class="block-header">
			<h2>Penawaran Harga<small>Input Penawaran</small></h2>
		</div>
				...
				<div class="header">
					<ul class="nav nav-tabs tab-nav-right" role="tablist">
						...
						<li role="presentation">
							<a href="#by_upload" data-toggle="tab">Upload</a>
						</li>
					</ul>	
				</div>
				<div class="tab-content">
					<div role="tabpanel" class="tab-pane fade in active" id="manual">
						<div class="header"><h2>INPUT PLAN BUDGET</h2>
						</div>
						<div class="body">
									...
									<div class="row clearfix">
											...
											<div class="form-group">
												...
												<div class="input-group">
													...
													<span class="input-group-addon">
														<button type="button" class="btn bg-red waves-effect"  onclick="cr_supp('template.php?plh=select/plh_supp.php&c=kode_supp&penawaran','Data Conveyor','800','500'); return false;"><i class="material-icons">search</i> </button>
													</span>
												</div>
											</div>
										</div>
										...
										<div class="col-md-2">	 
											<div class="form-group">
												...
												<div class="form-line">
													<div class="switch" ><label><input type="checkbox" name="rekom" id="rekom" value="YES" ><span class="lever"></span></label>
													</div>
												</div>
											</div>
										</div>
										<div class="col-md-2">	 
											<div class="form-group">
												<label>Butuh Kontrak</label>
												<div class="form-line">
													<div class="switch" ><label><input type="checkbox" name="rekontrak" id="rekontrak" value="NO" ><span class="lever"></span></label>
													</div>
												</div>
											</div>
										</div>
									...
									<div class="body">
										...
										<div class="col-md-2">	 
											<div class="form-group">
												<label>Butuh Kontrak</label>
												<div class="form-line">
													<div class="switch" ><label><input type="checkbox" name="rekontrak2" id="rekontrak2" value="NO" ><span class="lever"></span></label>
													</div>
												</div>
											</div>
										</div>
											...
											<div class="col-md-3">
												<button type="button" class="btn btn-outline-secondary" onclick="open_child('http://10.62.125.18:8080/share.cgi?ssid=6f91cac3be3d419e90e1b34441264fe8','upload','800','500'); return false;">DOK.REFF
												</button>
											</div>
										</div>
										<div class="row clearfix">	
...
// echo $sql1;
	...
	$jmdt=$jmdt+1;
	$kd_supplier=str_replace(' ', '',$kolF);
	$no_quo=str_replace(' ', '',$kolF."-".$periode."-".substr("0000".$jmdt,-4));
	$ling="http://10.62.125.18:8080/share.cgi?ssid=6f91cac3be3d419e90e1b34441264fe8/".$kolI;
	$lp=explode("-",$sect);

//$hilang=odbc_exec($koneksi_lp,"Delete from bps_quotation".$sql_del);
	//$qry_inst="insert into bps_quotation(part_no,part_nm,part_dtl,part_desc,kode_supp,no_quo,exp_quo,price,link_ref,day_aktf,ket_quo,stts_updt,lp_rekom,pic_updt,tgl_updt,jns_dok,sect) values('$kolB','$kolC','$kolD','$kolE','$kd_supplier','$no_quo','$kolG','$kolH','$ling','$day_aktf','$kolJ','UnUse','$kolK','$pic',getdate(),'Penawaran','$sect')";
	$qry_inst="insert into bps_quotation(part_no,part_nm,part_dtl,part_desc,kode_supp,no_quo,exp_quo,price,link_ref,day_aktf,ket_quo,stts_updt,lp_rekom,pic_updt,tgl_updt,jns_dok,sect) 
select '$kolB','$kolC','$kolD','$kolE','$kd_supplier','$no_quo','$kolG','$kolH','$ling','$day_aktf','$kolJ','UnUse','$kolK','$pic',getdate(),'Penawaran','$sect'
from bps_kontrak_supp where  tgl_berakhir>=getdate() and kode_supp='$kd_supplier' and status_ver=1";
...
if(isset($_POST['smpn']) or isset($_POST['del'])){
	...
	$kode_supp=str_replace(' ', '',$_POST['kode_supp']);
	$no_quo=$_POST['no_quo'];
...
$qry_inst="insert into bps_quotation(part_no,part_nm,part_dtl,part_desc,kode_supp,no_quo,exp_quo,price,dok_ref,link_ref, day_aktf, ket_quo, stts_updt,lp_rekom,pic_updt,tgl_updt,jns_dok,sect) values('$part_no','$part_nm','$part_dtl',$part_desc,'$kode_supp','$no_quo','$exp_quo','$price','$nmdok','$link_ref','$day_aktf','$ket_quo','UnUse','$rekom','$pic_updt',getdate(),'Penawaran','$sect')";
//echo $qry_inst;
					...
					<div class="form-group">
						...
						<div>
							<select class="selectpicker" style="width: 100%;"  name="cmd_cari" id="cmd_cari" >
								...
								<option value="a.lp">Purchasing</option>
								<option value="a.kode_supp">Kode Supplier</option>
						...
						<div class="body">
							<div class="table-responsive">
								...
								<tbody>
									...
									$sq_acc="select distinct sum(a.qty) as qty,expaired, a.price, a.part_no,
									a.part_nm ,a.part_dtl,a.part_desc,lp,min(lt_vp) as lt_vp,min(lt_datang) 
									as lt_datang,	min(lt_po) as lt_po,min(lt_pr) as lt_pr,min(lt_Quo) as lt_Quo,
									isnull((select count(distinct kode_supp)
									where max(Exp_Quo)> convert(nvarchar,getdate(),23)),0) as jm_quo,
									(case when max(Exp_Quo)<convert(nvarchar,getdate(),23) then null else 
									max(b.Exp_Quo) end) as Exp_Quo,a.uom
									from mstr_budget a full join bps_Quotation b on a.part_no=b.part_no 
									and a.part_nm=b.part_nm and a.part_dtl=b.part_dtl
									where dbo.cr_proseslp('quo',id_proses)='YES' AND expaired BETWEEN 
									'$rg_tgl0' AND '$rg_tgl1' $crlp $whrfil
									group by a.part_no,a.part_nm,a.part_dtl,a.part_desc,lp,expaired,
									a.price,a.uom	order by a.part_no ";
//echo $sq_acc;
									...
									while($baris1=odbc_fetch_array($tb_acc)){
										...
										$Exp_Quo=odbc_result($tb_acc,"Exp_Quo");
