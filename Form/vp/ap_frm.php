			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<div class="card">
					<div class="header">
						...
						<button type="button" name="kirim_ap" id="kirim_ap" class="btn bg-blue-grey waves-effect" onclick="$('#mdplhvp').modal('show');">AP(VP)</button>
						<button type="button" class="btn bg-blue waves-float " onclick="$('#mdupldvp').modal('show');">AP (Non VP)</button>
						</div>
					</div>
					<div class="row clearfix">
						<div class="body">
								...
								<div class="col-sm-3">	
										<div class="form-group">
											...
											<div class="input-group">
												<select  class="selectpicker" style="width: 100%;"  name="ap_term" id="ap_term" onchange="list_peri();" required>
