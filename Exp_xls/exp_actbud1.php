...
<table>
	<tr><th colspan="4" align="left">PT. Semarang Autocomp Manufacturing Indonesia</th></tr>
	<tr><th colspan="2" align="left"><?= $Jdl ; ?></th></tr>
	<tr><th colspan="2" align="left"><?= " TERM = ".$term ; ?></th></tr>
	<tr><th colspan="2" align="left"><?= " SECT = ".$sect ; ?></th></tr>
...
<table border="1">
	<tr>
		...
		<th rowspan="2" valign="top" width="300">Part Detail</th>
	...
	$data = odbc_exec($koneksi_lp,"SELECT *,(select top 1 price FROM bps_Quotation where 
		...
		FROM bps_budget a where sect='$sect' and term='$term' and Not exists (select *
