	...
	<div class="container-fluid">
		<div class="card">
			<div class="container-fluid">
				...
				if($sect=='PGA-IT'){
					$sql1="SELECT a.*,remark from bps_tmppr a left join bps_pr b on a.pr_no=b.pr_no
					and a.no_ctrl=b.no_ctrl
					where a.pr_no='$prno' order by part_no asc";
				}else{
					$sql1="SELECT a.*,remark from bps_tmppr a left join bps_pr b on a.pr_no=b.pr_no
					and a.no_ctrl=b.no_ctrl
				...
				if(isset($_POST['smpn'])){
					...
					<?php } ?>
					<div class="block-header"><h2>REVISI PR</h2></div>
					<form id="form1" name="form1" method="post">
						<div class="row clearfix">	
							<div class="form-group">
								<label>Remark PR <?= $_GET["sec"] ; ?></label>
								<div class="form-line">
							...
							<table id="example" class="table table-bordered table-striped table-hover dataTable js-exportable tabel2">
								...
								<tbody>
									...
									while($baris1=odbc_fetch_array($tb_area)){$row++;
										...
										$priceplan=odbc_result($tb_area,"price_tot");
										$cccode=odbc_result($tb_area,"cccode");
										$nctr=odbc_result($tb_area,"no_ctrl");
										$penawaran=odbc_result($tb_area,"penawaran");
										$lsctrl=$lsctrl.$nctr.",";
										?>
										<tr onclick="javascript:pilih(this);">
											...
											<td>
												<input type="text" name="cccode[]" id="cccode" value="<?php echo $cccode;?>" placeholder="Cost Center" class="form-control" readonly>
												<button name="bt1[]" onclick="open_child('../template.php?plh=select/plh_cccode.php&nomor=<?php echo $row;?>&k=4&o=cccode&c=carline_code&n=no_ctrl','Data Part Number','800','500'); return false;">...</button>
											</td>
											<td>
