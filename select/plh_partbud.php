 <div class="card">
	 ...
	 //$sql1="select * from bps_part where part_grp='$lp' and part_nm like '%$part_nm%'";
 		// $sql1="SELECT * from bps_part where status_part=1 and part_nm like '%$part_nm%' and lp='$lp' ";
        $sql1="SELECT * from bps_part where status_part='1' and lp='$lp' ";
